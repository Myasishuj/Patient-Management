//Generate Cloud Formation Template can see in localstack.template.json
...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService(
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET","x8aRLBjC1V9Tz1IuE3o47gCN88TwOiD4g2KuJX5u6H7EJ5PSpvnM0NYlcbL0W3Dc"));
    ...
    private DatabaseInstance createDatabaseInstance(String id, String dbName) {
        return DatabaseInstance.Builder
                ...
                .engine(DatabaseInstanceEngine.postgres(PostgresInstanceEngineProps
                        .builder().version(PostgresEngineVersion
                        .VER_17_2)
                        .build()))
                .vpc(vpc)
    ...
    private Cluster createEcsCluster(){
        return Cluster.Builder.create(this, "PatentManagementCLuster")
                .vpc(vpc)
    ...
    private FargateService createFargateService(String id,
        ...
        ContainerDefinitionOptions.Builder containerOptions = ContainerDefinitionOptions.builder()
                ...
                .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                        .logGroup(LogGroup.Builder.create(this, id + "Log Group")
